...
public class Driver {
 ...
 public static void testRun() {
     if (testHeap) {
    	 City first= new City(0);
    	 City second = new City(0);
    	 City third = new City(0);
    	 
    	 first.setNeighborAndWeight(second, 3);
    	 first.setNeighborAndWeight(third, 1);
    	 first.setMinDist(3);
    	
    	 second.setNeighborAndWeight(first, 2);
    	 second.setNeighborAndWeight(third, 5);
    	 second.setMinDist(2);
    	 
    	 third.setNeighborAndWeight(first, 1);
    	 third.setNeighborAndWeight(second, 5);
    	 third.setMinDist(5);
    	 
    	 ArrayList<City> tester = new ArrayList<City>();
    	 tester.add(first);
    	 tester.add(second);
    	 tester.add(third);
     ...
     if (testDijkstra) {
         ...
         System.out.println("Length of shortest path from start to dest: \n" +
                 testProgram2.findMinimumRouteDistance(cities.get(4), cities.get(0)));
     }
